...
const Index = () => {
  ...
  const raceTopFiveDisplay = useMemo(() => {
    if (raceTopFive.length < 5) return raceTopFive;
    // Show bars as podium-like layout: 4th, 2nd, 1st, 3rd, 5th
    return [raceTopFive[3], raceTopFive[1], raceTopFive[0], raceTopFive[2], raceTopFive[4]];
  }, [raceTopFive]);

  const raceMaxPercent = useMemo(
    () => Math.max(...raceTopFive.map((user) => Number(user.average_percentage || 0)), 1),
    [raceTopFive]
  );
  ...
  return (
    <div className="app-page min-h-screen flex flex-col bg-[radial-gradient(circle_at_15%_20%,rgba(255,214,224,0.45),transparent_42%),radial-gradient(circle_at_85%_10%,rgba(255,228,171,0.45),transparent_35%),linear-gradient(180deg,#f9edf1_0%,#f4f7ff_55%,#f7eef5_100%)]">
        ...
        <div className="relative w-full px-3 sm:px-5 md:px-7 lg:px-10">
          <div className="grid items-center gap-6 md:grid-cols-2 md:gap-8">
            ...
            >
              ...
              <h1 className="mb-5 font-display text-[2.35rem] font-black leading-tight sm:text-[2.9rem] md:text-5xl lg:text-6xl xl:text-7xl">
              ...
              <p className="mb-7 max-w-xl text-base leading-relaxed text-muted-foreground sm:text-lg md:text-xl">
                {t(
          ...
          <motion.div
            ...
            variants={fadeUp}
            custom={1}
            className="mt-8 rounded-2xl bg-transparent p-4 md:mt-10 md:p-5"
          >
            <div className="grid grid-cols-2 gap-2 sm:gap-3 lg:grid-cols-4">
              {features.map((feature, i) => (
                <motion.div
                  ...
                  className="rounded-xl bg-white/20 px-2 py-3 text-center backdrop-blur-[1px] sm:px-3 sm:py-4"
                >
                  <img
                    src={feature.image}
                    alt={feature.title}
                    ...
                    loading="lazy"
                  />
                  <h3 className="mb-0.5 line-clamp-2 font-display text-[13px] font-black leading-snug text-[#64172f] sm:text-base md:text-lg">
                    {feature.title}
                  </h3>
                  <p className="hidden text-xs font-medium leading-relaxed text-[#6d4a54] md:block md:text-sm">
                    {feature.desc}
                  </p>
                </motion.div>
              ))}
        ...
        >
          <defs>
            <linearGradient id="hero-cross-road" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="#6a4a57" stopOpacity="0.35" />
              <stop offset="55%" stopColor="#7f5a69" stopOpacity="0.46" />
              <stop offset="100%" stopColor="#6d4d58" stopOpacity="0.36" />
            </linearGradient>
            <linearGradient id="hero-cross-edge" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="#7a2038" stopOpacity="0.18" />
              <stop offset="45%" stopColor="#b23d58" stopOpacity="0.26" />
              <stop offset="100%" stopColor="#ca8a04" stopOpacity="0.18" />
            </linearGradient>
          </defs>

          <path
            d="M0,0 H1440 V106 C1260,86 1060,124 840,100 C640,80 480,48 300,78 C180,96 90,92 0,84 Z"
            fill="rgba(247,227,236,0.92)"
          />
      ...
      <div aria-hidden="true" className="pointer-events-none relative -mt-2 h-14 overflow-hidden sm:h-20 md:h-28">
        ...
        >
          <defs>
            <linearGradient id="quiz-materials-road" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="#6a4a57" stopOpacity="0.35" />
              <stop offset="55%" stopColor="#7f5a69" stopOpacity="0.46" />
              <stop offset="100%" stopColor="#6d4d58" stopOpacity="0.36" />
            </linearGradient>
            <linearGradient id="quiz-materials-road-edge" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="#7a2038" stopOpacity="0.18" />
              <stop offset="45%" stopColor="#b23d58" stopOpacity="0.26" />
              <stop offset="100%" stopColor="#ca8a04" stopOpacity="0.18" />
            </linearGradient>
          ...
          <path
            ...
            d="M-18,112 C180,56 370,156 610,116 C820,84 1000,56 1180,98 C1320,132 1400,124 1468,112"
            fill="none"
            stroke="url(#quiz-materials-road-edge)"
            strokeWidth="126"
            strokeLinecap="round"
          />
          <path
            ...
            d="M-18,112 C180,56 370,156 610,116 C820,84 1000,56 1180,98 C1320,132 1400,124 1468,112"
            fill="none"
            stroke="url(#quiz-materials-road)"
            strokeWidth="96"
            strokeLinecap="round"
          />
          <path
      ...
      <section className="relative py-8 sm:py-10 md:py-14">
        <div className="relative z-10 w-full px-3 sm:px-5 md:px-7 lg:px-10">
          ...
          >
            <h2 className="mb-3 font-display text-[1.55rem] font-black leading-[1.08] tracking-tight text-[#64172f] sm:text-[1.9rem] md:text-[2.65rem] lg:text-[2.95rem]">
              {t('Chủ đề tài liệu', 'Temas de materiales')}
            </h2>
            <p className="mx-auto max-w-2xl text-xs font-medium text-[#6d4a54] sm:text-base md:text-xl">
              {t(
          ...
          <div className="relative">
            <div
              ...
              className="flex gap-4 overflow-hidden px-1 pb-3 pr-4 md:gap-5 md:px-2 md:pr-6"
            ...
            {loopingSubjects.map((subject, i) => (
              ...
              >
                <Link to="/materials">
                  <Card className="card-hover h-full border border-transparent bg-transparent shadow-none transition-all duration-300">
                    <CardContent className="p-4 sm:p-5 md:p-6">
                      <div className="mb-3 h-40 w-full overflow-hidden rounded-2xl border border-transparent bg-transparent sm:h-48 md:mb-4 md:h-56">
                        <img
                      ...
                      <h3 className="mb-1.5 font-display text-lg font-bold sm:text-xl">{subject.name}</h3>
      ...
      <div aria-hidden="true" className="pointer-events-none relative -mt-2 h-14 overflow-hidden sm:h-20 md:h-28">
        ...
        >
          <defs>
            <linearGradient id="materials-road" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="#6a4a57" stopOpacity="0.35" />
              <stop offset="55%" stopColor="#7f5a69" stopOpacity="0.46" />
              <stop offset="100%" stopColor="#6d4d58" stopOpacity="0.36" />
            </linearGradient>
            <linearGradient id="materials-road-edge" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="#7a2038" stopOpacity="0.18" />
              <stop offset="45%" stopColor="#b23d58" stopOpacity="0.26" />
              <stop offset="100%" stopColor="#ca8a04" stopOpacity="0.18" />
            </linearGradient>
          ...
          <path
            ...
            d="M-18,112 C180,56 370,156 610,116 C820,84 1000,56 1180,98 C1320,132 1400,124 1468,112"
            fill="none"
            stroke="url(#materials-road-edge)"
            strokeWidth="126"
            strokeLinecap="round"
          />
          <path
            ...
            >
              ...
              <div className="grid gap-4 xl:grid-cols-[0.9fr_1.45fr]">
                <div className="relative flex h-full flex-col overflow-hidden p-5 md:p-6">
                    {leftProfileUser ? (
                      <>
                        <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-transparent px-3 py-1 text-xs font-bold text-amber-800">
                        ...
                        <div className="mt-3 grid grid-cols-2 gap-2">
                          <div className="rounded-xl border border-transparent bg-transparent px-3 py-2 text-center">
                      ...
                      <div className="rounded-2xl border border-dashed border-primary/25 bg-transparent p-5 text-sm text-slate-600">
                ...
                <div className="grid gap-4 xl:-mt-8">
                  <Card className="overflow-visible border border-transparent bg-transparent shadow-none md:overflow-hidden">
                    <CardContent className="p-5 md:p-6">
                      {raceTopFive.length ? (
                        <div className="relative overflow-visible rounded-3xl p-4 md:overflow-hidden md:p-5">
                          <div className="relative">
                            <div className="pointer-events-none absolute inset-0 hidden grid-rows-4 sm:grid">
                            ...
                            <div className="relative grid h-[14rem] grid-cols-5 items-end gap-1.5 pt-3 sm:h-[17rem] sm:gap-2 md:h-[22rem] md:gap-3">
                              {raceTopFiveDisplay.map((user) => {
                                const percentage = Math.max(0, Math.min(100, Number(user.average_percentage || 0)));
                                const score = Number(user.total_score || 0).toFixed(1);
                                const displayName = user.full_name || user.username || 'User';
                                const barRatio = raceMaxPercent > 0 ? percentage / raceMaxPercent : 0;
                                const barHeight = Math.max(24, Math.round(54 + barRatio * 208));
                                const isChampion = user.rank === 1;
                                const userInitial = displayName.charAt(0).toUpperCase();
                                const barClass =
                                  user.rank === 1
                                    ? 'from-[#ffd978] via-[#f5b83b] to-[#d99013]'
                                    : user.rank === 2
                                      ? 'from-[#dce7ff] via-[#adc3ee] to-[#7f9bd5]'
                                      : user.rank === 3
                                        ? 'from-[#ffe0cf] via-[#e6b090] to-[#cb8660]'
                                        : 'from-[#e8e6ff] via-[#c5c1f4] to-[#8c86de]';

                                return (
                                  <div key={user.id} className="flex h-full min-w-0 flex-col items-center justify-end">
                                    <div className="mb-1.5">
                                      {user.avatar_url ? (
                                        ...
                                        <div className="flex h-7 w-7 items-center justify-center rounded-full border border-slate-200 bg-white text-[10px] font-black text-primary shadow-sm sm:h-8 sm:w-8 sm:text-xs md:h-9 md:w-9">
                                          {userInitial}
                                        </div>
                                      )}
                                    </div>
                                    <div className={`mb-1.5 flex h-6 w-6 items-center justify-center rounded-full border text-[10px] font-black sm:h-7 sm:w-7 sm:text-[11px] ${isChampion ? 'border-amber-300 bg-amber-100/90 text-amber-800' : 'border-slate-200 bg-white/70 text-slate-600'}`}>
                                      {user.rank}
                                    </div>
                                    <div className={`mb-1 rounded-full px-2 py-0.5 text-[10px] font-extrabold ${isChampion ? 'bg-amber-50 text-amber-800' : 'bg-white/70 text-slate-600'}`}>
                                      {percentage.toFixed(1)}%
                                    </div>
                                    <div
                                      className={`relative flex w-full max-w-[54px] items-end justify-center overflow-hidden rounded-t-2xl px-1 pb-1 text-[9px] font-black text-white shadow-[0_12px_24px_rgba(95,20,40,0.16)] bg-gradient-to-b sm:max-w-[64px] sm:text-[10px] md:max-w-[74px] ${barClass}`}
                                      style={{ height: `${barHeight}px` }}
                                    >
                                      <div className="absolute inset-x-1.5 top-1.5 h-1 rounded-full bg-white/35" />
                                      <span className="relative z-10">{score}</span>
                                    </div>
                                    <div className="mt-1.5 h-1.5 w-[72%] rounded-full bg-primary/20" />
                                    <div className="mt-2 w-full max-w-[74px] text-center text-[10px] font-bold leading-tight text-slate-700 sm:max-w-[84px] sm:text-[11px] md:max-w-[92px] md:text-xs">
      ...
      <div aria-hidden="true" className="pointer-events-none relative mt-12 h-14 overflow-hidden sm:mt-8 sm:h-20 md:-mt-2 md:h-28">
        <svg
          viewBox="0 0 1440 220"
          preserveAspectRatio="none"
          className="absolute inset-0 h-full w-full"
        >
          <defs>
            <linearGradient id="leaderboard-cta-road" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="#6a4a57" stopOpacity="0.35" />
              <stop offset="55%" stopColor="#7f5a69" stopOpacity="0.46" />
              <stop offset="100%" stopColor="#6d4d58" stopOpacity="0.36" />
            </linearGradient>
            <linearGradient id="leaderboard-cta-road-edge" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="#7a2038" stopOpacity="0.18" />
              <stop offset="45%" stopColor="#b23d58" stopOpacity="0.26" />
              <stop offset="100%" stopColor="#ca8a04" stopOpacity="0.18" />
            </linearGradient>
          ...
          <path
            ...
            d="M-18,112 C180,56 370,156 610,116 C820,84 1000,56 1180,98 C1320,132 1400,124 1468,112"
            fill="none"
            stroke="url(#leaderboard-cta-road-edge)"
            strokeWidth="126"
            strokeLinecap="round"
          />
          <path
            ...
            d="M-18,112 C180,56 370,156 610,116 C820,84 1000,56 1180,98 C1320,132 1400,124 1468,112"
            fill="none"
            stroke="url(#leaderboard-cta-road)"
            strokeWidth="96"
            strokeLinecap="round"
          />
          <path
      ...
      <section className="relative py-10 sm:py-12 md:py-14">
        <div className="relative z-10 w-full px-3 sm:px-5 md:px-7 lg:px-10">
          <motion.div
            ...
            variants={fadeUp}
            custom={0}
            className="relative overflow-hidden rounded-[2rem] border border-black/15 bg-transparent px-6 py-7 md:px-8 md:py-9 lg:px-10"
          >
            ...
            <div className="relative grid gap-6 lg:grid-cols-[1.35fr_auto] lg:items-center">
              <div>
                <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-primary/20 bg-transparent px-3 py-1 text-sm font-semibold text-primary">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <span className="inline-flex items-center rounded-full border border-primary/20 px-3 py-1 text-sm font-semibold text-[#24324f]">
              ...
              <div className="flex flex-col items-start gap-3 lg:items-end">
                ...
                {!isAuthenticated && (
                  <Link to="/quizzes">
                    <Button
                      variant="outline"
                      className="rounded-xl border-primary/25 bg-white/60 px-5 text-sm font-semibold text-primary hover:bg-white"
                    >
